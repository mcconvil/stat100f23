...
* Class in full swing:
    ...
    + Lecture quiz will be released on Gradescope after class on Wednesday.
...
![](img/flowchart.002.png){.fragment width="800" height="700"}
![](img/flowchart.003.png){.fragment width="600" height="800"}
...
* For you to **learn** to code and to **think** statistically.
    + The Stat 100 Teaching Team will help guide that learning without giving you the answers.
...
* **Seasoned data scientist** can/should:
    ...
    + Run the code in `R` and draw conclusions based on their data to reduce risk of perpetuating biases that exist in ChatGPT's training data.
...
![](img/packages.003.jpeg){width="90%"}
---
