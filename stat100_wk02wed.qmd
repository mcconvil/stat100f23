...
![](img/o_ring_rockets.jpg){width="35%" fig-align="center"}
...
![](img/wp_shooter.png){width="60%" fig-align="center"}
...
Be careful that your design choices don't cause your viewer draw incorrect conclusions about the data:
...
```{r}
bike_counter_july <- read_csv("data/bike_counter_july.csv")

# Inspect the data
glimpse(bike_counter_july)
```
...
class(bike_counter_july$Day)
class(bike_counter_july$Total)
class(bike_counter_july)
